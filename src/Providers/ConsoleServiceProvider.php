...
class ConsoleServiceProvider extends ServiceProvider
{
    ...
    private const CONFIG_SOURCE_LARAVEL_APP = 'laravel-app';
    private const CONFIG_SOURCE_LARAVEL_ENV = 'laravel-environment';
    private const CONFIG_SOURCE_PLESK_ENV = 'plesk-environment';
    private const CONFIG_SOURCE_DEFAULT = 'default';
    ...
    private function ensureConfigSource(): string
    {
        if (config('plesk-ext-laravel.queue-worker.enabled') !== null) {
            return self::CONFIG_SOURCE_LARAVEL_APP;
        }

        if (env('PLESK_EXT_LARAVEL_QUEUE_WORKER_ENABLED') !== null) {
            return self::CONFIG_SOURCE_LARAVEL_ENV;
        }
        ...
        return self::CONFIG_SOURCE_DEFAULT;
    }
